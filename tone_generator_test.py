...
class ToneGeneratorTest:
    ...
    def show_auto_close_message(self):
        eval_window = tk.Toplevel(self.parent_frame.winfo_toplevel())
        ...
        eval_window.transient(self.parent_frame.winfo_toplevel())
        ...
        tk.Label(eval_window, text="OCENA WYNIKÓW - TEST 2",
                 font=('Arial', 12, 'bold'), bg='#FFFFFF', fg='#000000').pack(pady=(20, 5))
        tk.Label(eval_window, text="Czy generator częstotliwości działa poprawnie?",
